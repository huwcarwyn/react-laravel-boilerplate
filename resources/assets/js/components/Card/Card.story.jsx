...
storiesOf('Card', module)
  ...
  .add('Default', () => (
    <Card>
      ...
      maxime, expedita ullam qui culpa doloremque earum dignissimos fugit rerum
      quam, at ipsam, incidunt aut laboriosam, eos veritatis aperiam.
    </Card>
  ))
  ...
  .add('With list items', () => (
    <Card title="Card with a list in it">
      <CardListItem>item number 1</CardListItem>
      <CardListItem>item number 2</CardListItem>
      <CardListItem>item number 3</CardListItem>
      <CardListItem>item number 4</CardListItem>
    </Card>
  ))
